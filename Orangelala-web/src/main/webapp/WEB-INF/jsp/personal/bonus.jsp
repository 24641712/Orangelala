...
<head>
    ...
    <link href="${ctx}/staticAmazeUI-2.4.2/assets/css/admin.css" rel="stylesheet" type="text/css">
    ...
    <link href="${ctx}/static/css/bostyle.css" rel="stylesheet" type="text/css">
                            ...
                            <div class="cart-table-th">
                                ...
                                <div class="order-main">
                                    ...
                                    <ul class="item-list">
                                        <li class="td td-from">
                                            <div class="item-img">
                                                <img src="${ctx}/static/images/566fda5cN4b8a1675.gif">
                                            </div>
                                        ...
                                        <li class="td td-usestatus ">
                                            <div class="item-usestatus ">
                                                <p>可使用</p><span><img src="${ctx}/static/images/gift_stamp_1.png"</span>
                                            </div>
                                        </li>
                                    </ul>
                            ...
                            <div class="cart-table-th">
                                ...
                                <div class="order-main">
                                    ...
                                    <ul class="item-list">
                                        ...
                                        <li class="td td-usestatus ">
                                            <div class="item-usestatus ">
                                                <p>已用完</p><span><img src="${ctx}/static/images/gift_stamp_2.png"</span>
                                            </div>
                                        </li>
                                    </ul>
                                    ...
                                    <ul class="item-list">
                                        ...
                                        <li class="td td-usestatus ">
                                            <div class="item-usestatus ">
                                                <p>已过期</p><span><img src="${ctx}/static/images/gift_stamp_3.png"</span>
                                            </div>
                                        </li>
                                    </ul>
