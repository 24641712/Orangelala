...
<head>
    ...
    <link href="${ctx}/static/css/blstyle.css" rel="stylesheet" type="text/css">
                                    ...
                                    <li>
                                        <div  class="cards-carousel">
                                            <div class="mask">
                                                ...
                                                <div class="bank ng-binding" style="background-image: url(${ctx}/static/images/combo.png);">中国农业银行</div>
                                                <div class="details">
                                                    <a>查看详情</a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="cards-details">
                                            <div class="bank-name">
                                                <div class="name fn-left" style="background-image: url(${ctx}/static/images/combo.png);"></div>
                                    ...
                                    <li>
                                        <div  class="cards-carousel">
                                            <div class="mask">
                                                ...
                                                <div class="bac fn-left"></div>
                                                <div class="bank ng-binding" style="background-image: url(${ctx}/static/images/combo1.png);">中国建设银行</div>
                                                <div class="details">
                                                    <a>查看详情</a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="cards-details">
                                            <div class="bank-name">
                                                <div class="name fn-left" style="background-image: url(${ctx}/static/images/combo1.png);"></div>
                                                <span class="close fn-right"><a>X</a></span>
                                            </div>
                                            <div class="bank-detail">
                                                <div class="totalin fn-left">
                                    ...
                                    <li>
                                        <div  class="cards-carousel">
                                            <div class="mask">
                                                ...
                                                <div class="bac fn-left"></div>
                                                <div class="bank ng-binding" style="background-image: url(${ctx}/static/images/combo2.png);">浦发银行</div>
                                                <div class="details">
                                                    <a>查看详情</a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="cards-details">
                                            <div class="bank-name">
                                                <div class="name fn-left" style="background-image: url(${ctx}/static/images/combo2.png);"></div>
                                                <span class="close fn-right"><a>X</a></span>
                                            </div>
                                            <div class="bank-detail">
                                                <div class="totalin fn-left">
                                    ...
                                    <li>
                                        <div  class="cards-carousel">
                                            <div class="mask">
                                                ...
                                                <div class="bac fn-left"></div>
                                                <div class="bank ng-binding" style="background-image: url(${ctx}/static/images/combo3.png);">中国光大银行</div>
                                                <div class="details">
                                                    <a>查看详情</a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="cards-details">
                                            <div class="bank-name">
                                                <div class="name fn-left" style="background-image: url(${ctx}/static/images/combo3.png);"></div>
                                                <span class="close fn-right"><a>X</a></span>
                                            </div>
                                            <div class="bank-detail">
                                                <div class="totalin fn-left">
