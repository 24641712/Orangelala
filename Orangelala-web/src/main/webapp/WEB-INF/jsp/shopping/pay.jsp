...
<div class="concent">
    ...
    <div class="paycont">
        ...
        <div class="logistics">
            <h3>选择支付方式</h3>
            <ul class="pay-list">
                <li class="pay card"><img src="${ctx}/static/images/wangyin.jpg" />银联<span></span></li>
                <li class="pay qq"><img src="${ctx}/static/images/weizhifu.jpg" />微信<span></span></li>
                <li class="pay taobao"><img src="${ctx}/static/images/zhifubao.jpg" />支付宝<span></span></li>
            </ul>
        </div>
        <div class="clear"></div>
                                    ...
                                    <li class="td td-item">
                                        <div class="item-pic">
                                            <a href="#" class="J_MakePoint">
                                                <img src="${ctx}/static/images/kouhong.jpg_80x80.jpg" class="itempic J_ItemImg"></a>
                                        </div>
                                        <div class="item-info">
            ...
            <div class="pay-confirm clearfix">
                ...
                <div id="holyshit269" class="submitOrder">
                    <div class="go-btn-wrap">
                        <a id="J_Go" href="${ctx}/index/success" class="btn-go" tabindex="0" title="点击此按钮，提交订单">提交订单</a>
                    </div>
                </div>
                <div class="clear"></div>
            </div>
