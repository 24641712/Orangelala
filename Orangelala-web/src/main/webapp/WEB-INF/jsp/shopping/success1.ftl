...
<title>付款成功页面</title>
<link rel="stylesheet"  type="text/css" href="${ctx}/static/assets/css/amazeui.css"/>
...
<link href="${ctx}/static/css/sustyle.css" rel="stylesheet" type="text/css" />
   ...
   <div class="successInfo">
     ...
     <div class="option">
       <span class="info">您可以</span>
        <a href="${ctx}/index/order" class="J_MakePoint">查看<span>已买到的宝贝</span></a>
        <a href="${ctx}/index/orderinfo" class="J_MakePoint">查看<span>交易详情</span></a>
     </div>
    </div>
  </div>
</div>
