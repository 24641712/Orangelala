    ...
    <div class="scoll">
        <section class="slider">
            <div class="flexslider">
                <ul class="slides">
                    <li>
                        <img src="${ctx}/static/images/01.jpg" title="pic" />
                    </li>
                    <li>
                        <img src="${ctx}/static/images/02.jpg" />
                    </li>
                    <li>
                        <img src="${ctx}/static/images/03.jpg" />
                    </li>
                </ul>
            </div>
        </section>
        ...
        <div class="clearfixLeft" id="clearcontent">
            ...
            <div class="box">
                ...
                <div class="tb-booth tb-pic tb-s310">
                    <a href="${ctx}/static/images/01.jpg"><img src="${ctx}/static/images/01_mid.jpg" alt="细节展示放大镜特效" rel="${ctx}/static/images/01.jpg" class="jqzoom" /></a>
                </div>
                <ul class="tb-thumb" id="thumblist">
                    <li class="tb-selected">
                        <div class="tb-pic tb-s40">
                            <a href="#"><img src="${ctx}/static/images/01_small.jpg" mid="${ctx}/static/images/01_mid.jpg" big="${ctx}/static/images/01.jpg"></a>
                        </div>
                    </li>
                    <li>
                        <div class="tb-pic tb-s40">
                            <a href="#"><img src="${ctx}/static/images/02_small.jpg" mid="${ctx}/static/images/02_mid.jpg" big="${ctx}/static/images/02.jpg"></a>
                        </div>
                    </li>
                    <li>
                        <div class="tb-pic tb-s40">
                            <a href="#"><img src="${ctx}/static/images/03_small.jpg" mid="${ctx}/static/images/03_mid.jpg" big="${ctx}/static/images/03.jpg"></a>
                        </div>
                    </li>
                </ul>
            </div>
...
<div class="pay">
    ...
    <li>
        <div class="clearfix tb-btn tb-btn-buy theme-login">
            <a id="LikBuy" title="点此按钮到下一步确认购买信息" href="${ctx}/index/pay">立即购买</a>
        </div>
    </li>
    <li>
    ...
    <div class="match-comment">
        <ul class="like_list">
            ...
            <li class="total_price">
                ...
                <p class="save_all">共省:<span>￥463.00</span></p> <a href="${ctx}/index/pay" class="buy_now">立即购买</a> </li>
    ...
    <div class="browse">
        <div class="mc">
            <ul>
                ...
                <li class="first">
                    <div class="p-img">
                        <a  href="#"> <img class="" src="${ctx}/static/images/browse1.jpg"> </a>
                    </div>
